class SecurePlant:
    ...
    def get_height(self) -> int:
        """Provide safe access to plants height."""
        return self._height

    def get_age(self) -> int:
        """Provide safe access to plants age."""
        return self._age
...
def ft_garden_security() -> None:
    """Test the garden security and display data"""
    ...
    print(f"Current plant: {new_plant.name} "
          f"({new_plant.get_height()}cm, "
          f"{new_plant.get_age()} days)")
